...
#
# 使用方法:
#   bash dllm_reasoning/scripts/run_train.sh <num_gpus> <save_dir> [log_file] [其他配置...]
#
# 示例:
#   bash dllm_reasoning/scripts/run_train.sh 4 ./checkpoints/my_exp
#   bash dllm_reasoning/scripts/run_train.sh 4 ./checkpoints/my_exp training.log
#   nohup bash dllm_reasoning/scripts/run_train.sh 4 ./checkpoints/my_exp training.log &
